...
var builder = {
  ...
  featuresWithUpdate: [],
  systemDependencies: Object.create(null),
  updateEnabled: false,
  ...
  createIncludes: function() {
    ...
    // guard against duplicate includes in future
    this.systemDependencies["Servo"] = true;
    this.systemDependencies["Wire"] = true;
    ...
    for (var i = 0, len = this.selectedFeatures.length; i < len; i++) {
      ...
      if (feature.systemDependencies) {
        for (var j = 0; j < feature.systemDependencies.length; j++) {
          ...
          if (!this.systemDependencies[d.className]) {
            includes += "#include <" + d.path + d.className + ".h>\n";
            this.systemDependencies[d.className] = true;
          }
        }
      }
